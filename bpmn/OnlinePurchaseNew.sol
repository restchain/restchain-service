...
contract resttt {
    ...
    //Evento che fa capire che è stata eseguita un funzione
    ...
    constructor() public{
        ...
        roles["Seller"] = 0x56AE0160ab7dD91850FebBA7cDb63B86c5c8857F;
        optionalRoles["Buyer"] = 0x0000000000000000000000000000000000000000;
    ...
    modifier Owner(string memory task)
{
    ...
    //Concetto di opzionale , si può sottoscrivere dopo
    ...
    function sid_abba267c_92e3_4944_a98a_d317e035c861(string memory motivation) public checkOpt(optionalList[0]) {
    ...
    function sid_e385b492_6b2b_475b_a8dd_8fc09513393b(string memory shipAddress) public checkOpt(optionalList[0]) {
    ...
    function sid_b9828a39_b70d_4470_b5d2_61cda9b2bc64(address payable to) public payable checkOpt(optionalList[0]) {
    ...
    function sid_2F272EDB_9940_467E_AADC_2B485679AF43(string memory shipInfo) public checkMand(roleList[0]) {
    ...
    function sid_06caa7c5_fba5_4524_8d4d_2f24b1d51468(string memory invoiceInfo) public checkMand(roleList[0]) {
    ...
    function sid_80A4BF32_23C1_4585_A70C_26A40D63DA7F() private {
        ...
        if (currentMemory.reiterate == false) 
        {
            enable("sid-E761CE7E-ED53-413A-A3C8-3D6569A80525");
