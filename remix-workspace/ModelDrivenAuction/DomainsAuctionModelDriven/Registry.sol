...
contract Registry is IRegistry,IRegistry2{
    ...
    {
        return offer(_amount,_item,_participant);
    }
    ...
    function getSummary() public returns ( bytes32[] memory, address[]  memory, uint[] memory){
        ...
        return (currentBatch.domains,bidder ,bids);
    }
